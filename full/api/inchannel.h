...
public:
	...
	/** Whether the inchannel belongs to an entity host which is an openvz-based VE */
	bool is_ve_attached() { return __ve_attached; }
	/** Set the attribute to indicate whether the inchannel belongs to an entity host which is an openvz-based VE */
	void set_ve_attached(bool v) { __ve_attached = v; }
...
protected:
	...
	bool __ve_attached;      ///< whether the inchannel belongs to a VE-proxy entity
