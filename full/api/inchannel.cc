...
InChannel::InChannel(Entity* theowner) : __extname(string("")),
		__owner(theowner), __alignment(theowner->alignment()), __ve_attached(false)  {
...
InChannel::InChannel(Entity* theowner, string icname) :
    		__extname(icname), __owner(theowner),
    		__alignment(theowner->alignment()), __ve_attached(false) {
