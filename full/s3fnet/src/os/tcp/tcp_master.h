...
class TCPMaster : public SessionMaster {
 ...
 public:
  ...
  /** the actual body of the slow_timer_callback function */
  void slow_timer_callback_body(Activation);
  /** The callback function registered with the fast_timer_callback_proc */
  void fast_timer_callback(Activation);
  /** the actual body of the fast_timer_callback function */
  void fast_timer_callback_body(Activation);
