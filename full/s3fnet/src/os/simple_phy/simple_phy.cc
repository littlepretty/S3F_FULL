...
void SimplePhy::receivePacket(Activation pkt, int nw_iface)
{
  ...
  PHYOptionToAbove phyupopt;
  phyupopt.nw_iface = nw_iface;
  parent_prot->popup(pkt, this, (void*)&phyupopt, sizeof(PHYOptionToAbove));
}
