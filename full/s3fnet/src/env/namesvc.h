...
class NameService {
 ...
 public:
  ...
  typedef S3FNET_MAP(int, Host*) VEID2HOSTOBJ_MAP;
  ...
  /** Resolve VEID to the corresponding Host object. */
  Host* veid2hostobj(int id);

  /** Resolve IPADDR to the corresponding VEID. */
  int ip2veid(IPADDR addr);

  /** Resolve Host Nhi to the corresponding VEID. */
  int hostnhi2veid(const S3FNET_STRING& nhi);

  /** Return the ip2iface_map */
  IP2IFACE_MAP* get_ip2iface_map() { return ip2iface_map; }

  /** Return the veid2hostobj_map */
  VEID2HOSTOBJ_MAP* get_veid2hostobj_map() { return veid2hostobj_map; }

  /** Print the ip2iface_map */
  void print_ip2iface_map();

  /** Print the veid2hostobj_map */
  void print_veid2hostobj_map();
 ...
 protected:
  ...
  VEID2HOSTOBJ_MAP* veid2hostobj_map; ///< map from veid (emulation) to Host* object
