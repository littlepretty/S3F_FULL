...
class Host : public Entity, public DmlObject, public ProtocolGraph {
 ...
 public:
  ...
  /** Return true if this host is an openflow switch. */
  bool isOpenFlowSwitch() { return is_of_switch; }

  /** Return true if this host supports OpenVZ-based Emulation. In particular, the DML file assign a veid to this host. */
  bool isOpenVZEmu() { return is_openVZEmu;}
  ...
  /** Return the list of network interfaces associated to this host */
  S3FNET_HOST_IFACE_MAP getNetworkInterfaceMap() {return ifaces;}

  /** Return the VE's ID (OpenVZ VE) of this host */
  int getVEID() {return veid;}

  bool is_of_ctrl;
  OpenFlowControllerSession* of_ctrl_sess;
  int of_ctrl_type;
 ...
 protected:
  ...
  /** Whether this machine is an openflow switch */
  bool is_of_switch;
  ...
  /* for openVZ emulation */
  int veid; ///< ID of the associated VE
  bool is_openVZEmu; ///< whether the host is an openVZ emulation host
